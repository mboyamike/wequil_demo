...
import 'package:user_repository/src/repositories/user_repository.dart' as _i2;
...
class MockUserRepository extends _i1.Mock implements _i2.UserRepository {
  ...
  @override
  _i3.Future<_i4.User?> fetchUser({String? uID, bool? forceFetch = false}) =>
      (super.noSuchMethod(
          Invocation.method(
              #fetchUser, [], {#uID: uID, #forceFetch: forceFetch}),
          returnValue: Future<_i4.User?>.value()) as _i3.Future<_i4.User?>);
  @override
  _i3.Future<void> saveUser({_i4.User? user}) =>
      (super.noSuchMethod(Invocation.method(#saveUser, [], {#user: user}),
